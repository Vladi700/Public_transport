...
trams <- as.data.frame(read.csv('data/sections.csv'))
lines_stations <- as.data.frame(read.csv('data/station_lines.csv'))
lines_trams <- as.data.frame(read.csv('data/section_lines.csv'))
means_of_transport <- as.data.frame(read.csv('data/transport_modes.csv'))
```
...
```{r}
out_dir <- "edges_by_city"
dir.create(out_dir, showWarnings = FALSE, recursive = TRUE)

safe_city <- gsub("[^A-Za-z0-9_-]+", "_", city_name)  # optional: sanitize name
outfile <- file.path(out_dir, paste0(safe_city, ".csv"))
